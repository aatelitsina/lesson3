# Научите бота вычислять математические выражения с целыми числами от одного до десяти, заданные словами. Например, “сколько будет три минус два” или “сколько будет четыре умножить на шесть”.
